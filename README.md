...
# SOURCE PROTOCOL validator node on Akash Network
  
# Нода валидатора сети SOURCE PROTOCOL, развертка в Akash Network.
...
| [Discord SOURCE PROTOCOL](https://discord.gg/zj8xxUCeZQ) | [Explorer SOURCE PROTOCOL](https://exp.nodeist.net/Source) | [Site SOURCE PROTOCOL](https://www.sourceprotocol.io/) | [Twitter SOURCE PROTOCOL](https://www.twitter.com/sourceprotocol_) |
|:--:|:--:|:--:|:--:|
  
<div align="center">
  
[English version](https://github.com/Dimokus88/SOURCE-PROTOCOL/tree/main#english-version) | [Русская версия](https://github.com/Dimokus88/SOURCE-PROTOCOL/tree/main#%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B0%D1%8F-%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F) 
...
# English version
### Deployment of the SOURCE PROTOCOL node.

Deploy [deploy.yml](https://github.com/Dimokus88/SOURCE-PROTOCOL/blob/main/deploy.yml) **SOURCE PROTOCOL** nodes with **Cloudmos (Akashlytics)** ( [use instructions here](https://github.com/Dimokus88/guides/blob/main/Akashlytics/EN-guide.md) ) by setting the values ​​in the corresponding `deploy.yml` variables:
...
### Creating an SOURCE PROTOCOL validator
...
[Back to top](https://github.com/Dimokus88/SOURCE-PROTOCOL/blob/main/README.md#SOURCE-PROTOCOL-validator-node-on-akash-network)

**Thank you for using Akash Network!**

___
# Русская версия
### Развертка ноды SOURCE PROTOCOL.

Разверните [deploy.yml](https://github.com/Dimokus88/SOURCE-PROTOCOL/blob/main/deploy.yml) ноды **SOURCE PROTOCOL** с помощью **Cloudmos (Akashlytics)**  ([инструкция по использованию здесь](https://github.com/Dimokus88/guides/blob/main/Akashlytics/RU-guide.md)) установив значения в соответствующих переменных  `deploy.yml`: 
...
### Создание валидатора SOURCE PROTOCOL
...
[К началу](https://github.com/Dimokus88/SOURCE-PROTOCOL/blob/main/README.md#SOURCE-PROTOCOL-validator-node-on-akash-network)
